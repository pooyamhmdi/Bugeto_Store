...
namespace Bugeto_Store.Presistence.Migrations
{
    ...
    [Migration("20250916081556_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bugeto_Store.Domain.Entities.Cart.Cart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Bugeto_Store.Domain.Entities.Cart.CartItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Bugeto_Store.Domain.Entities.Fainances.RequestPay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Bugeto_Store.Domain.Entities.Cart.CartItem", b =>
                {
                    b.HasOne("Bugeto_Store.Domain.Entities.Cart.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Bugeto_Store.Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("Bugeto_Store.Domain.Entities.Fainances.RequestPay", "RequestPay")
                        .WithMany("Orders")
